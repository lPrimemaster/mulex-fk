...
namespace mulex
{
	...
	bool RexDependencyManager::checkDependencyExists()
	{
		RdbAccess rdb;
	...
	bool RexDependencyManager::checkDependencyRunning()
	{
		RdbAccess rdb;
	...
	RexDependencyManager& RexDependencyManager::required(bool r)
	{
		_dep_req = r;
		return *this;
	}

	RexDependencyManager& RexDependencyManager::onFail(const RDMFailFlags& flag)
	{
		_dep_fail = flag;
		return *this;
	}
