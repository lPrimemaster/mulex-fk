...
namespace mulex
{
	...
	MX_RPC_METHOD void PdbUserMetadataSet(mulex::RPCGenericType data);
	MX_RPC_METHOD mulex::RPCGenericType PdbUserMetadataGet();
	void FdbInit();
	void FdbClose();
	...
	MX_RPC_METHOD MX_PERMISSION("upload_files") mulex::FdbHandle FdbChunkedUploadStart(mulex::string128 mimetype, mulex::string32 extension);
